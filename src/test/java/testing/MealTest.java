...
// musi byc bez literowki test i metoda Stream
    @ParameterizedTest
...
void cakeNameShouldEndWithCake (String name){
    ...
    private static Stream<String> createCakeNames(){
        List<String> cakeNames = Arrays.asList("Cheesecake", "Fruidcake", "Cupcake");
